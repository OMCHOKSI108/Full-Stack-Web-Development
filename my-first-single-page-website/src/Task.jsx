        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label>
                    ...
                    />
                    {errors.confirmPassword && <p className="field-error" style={{ color: 'red' }}>{errors.confirmPassword}</p>}
                </label>
